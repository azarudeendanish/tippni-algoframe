...
// Generic wrapper
export function Action({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <div
      className="p-0 inline-flex items-center gap-2 rounded-md text-xs hover:bg-secondary focus:outline-none focus-visible:ring-2 focus-visible:ring-ring cursor-pointer"
      aria-label={label}
    >
      {icon}
    </div>
...
export const ReplyIcon = ({ stroke }: any) => (
...
export const ForwardIcon = ({ stroke }: any) => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path
...
export const HeartIcon = ({ stroke }: any) => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path
...
export const BookmarkIcon = ({ stroke }: any) => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path
