...
import { MoreHorizontal, MessageCircle, Heart, Repeat2, Bookmark, CommandIcon } from "lucide-react"
...
export default function PostCard({ username, handle, text, avatarUrl, imageSrc }: PostCardProps) {
  console.log('postcard username', username);
  console.log('postcard text', text);
  console.log('postcard avatarUrl',avatarUrl);
  console.log('postcard imageSrc',imageSrc);
